...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- THIS IS BROKEN due to Vite not playing nice with TailwindCSS -->
        <!-- @vite('resources/css/app.css') -->
        <!-- Due to time constraints, using CDN -->
        <script src="https://cdn.tailwindcss.com"></script>

        <style>
        @import url('https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,400;0,700;0,900;1,400;1,700&display=swap');
        ...
        <!-- AlpineJS due to Vite being a pain, no VueJS -->
                            ...
                            <div class="items-center">
                                <div x-data="searchRESTCountries()">
                                    <form class="mb-8" @submit.stop.prevent="fetchCountries()">
                                        ...
                                        <input
                                            type="text"
                                            name="searchRESTCountries"
                                            x-model="searchRESTCountries"
